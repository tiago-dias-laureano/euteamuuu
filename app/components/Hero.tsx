      ...
      <div className="flex flex-col md:flex-row items-center md:justify-between">
        <div className="space-y-8 md:w-[50%]">
          ...
          <div className="description text-center md:text-left text-gray-200 mt-4">
            ...
            Personalize com uma linha do tempo especial, contador de dias
            juntos, lembretes de momentos importantes e um QR Code para
          ...
          <div className="mt-6 w-full">
            <button className="w-full bg-gradient-to-r from-red-500 to-[#BF2F32] px-8 py-4 rounded-lg text-lg hover:opacity-90 transition-opacity duration-300">
